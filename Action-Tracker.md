---
type: action-tracker
updated: 2026-06-02T15:21:26-05:00
story_count: 8
---
...
|---|---|---|---|---|---|---|---|
| MAI CRM Build | MAI-1633 | PROD: Flexdash component flips back to "no component groups configured" | QA | High | — | 2026-06-02 | [Jira](https://f2strategy.atlassian.net/browse/MAI-1633) |
...
> [!note] MAI-1621 "Financial account: Investment account RT page updates" dropped from active set since the 2026-06-02 09:22 run (moved to Done). Never routed (MAI unmapped), so no archive stub written.
