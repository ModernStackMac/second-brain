---
type: action-tracker
updated: 2026-06-03T09:22:26-05:00
story_count: "9"
---
...
| MAI CRM Build | MAI-1639 | New Fund Account: Make investing entity field on LWC not required | Active | High | — | 2026-06-03 | [Jira](https://f2strategy.atlassian.net/browse/MAI-1639) |
...
> [!note] MAI-1629 "Add Household Member Records for Member Records" dropped from active set since the 2026-06-02 19:21 run (moved to Done). Never routed (MAI unmapped), so no archive stub written. MAI-1634 and MAI-1639 added this run (both Active, High).
> [!note] Linear (MSS + HM) not synced this run — no Linear MCP connected (only OAuth/auth tools available) and no user present for the scheduled run. Meadow / Flex Dash stories not refreshed.
