---
type: action-tracker
updated: 2026-06-01T07:21:47-05:00
story_count: 8
---
...
|---|---|---|---|---|---|---|---|
| MAI CRM Build | MAI-1633 | PROD: Flexdash component reverts to "no component groups configured" | To Do | High | — | 2026-06-01 | [Jira](https://f2strategy.atlassian.net/browse/MAI-1633) |
| MAI CRM Build | MAI-1614 | Fund Assignment: Assignee contact search bug | Active | High | — | 2026-05-29 | [Jira](https://f2strategy.atlassian.net/browse/MAI-1614) |
...
> [!note] MAI and CET rows are shown for visibility but are NOT routed to project folders — project-mapping.md has no matching (workspace, key) entry (MAI key=TBD, actual=MAI; cetera key=F2, actual=CET). See `raw/story-sync-unrouted.md`.
