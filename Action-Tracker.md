---
type: action-tracker
updated: 2026-06-05T07:20:50-05:00
story_count: "7"
---
...
> [!note] CHANGES this run: MAI-1641 (Fund Assignment field bug) reassigned to Vincent Wang (status QA) — dropped from Mac's active set. MAI-1633 (Flexdash component bug) Cancelled and unassigned — dropped. No archive stubs written because MAI is unmapped (archiving would require guessing a destination slug).
> [!note] Stale file flag: `wiki/projects/cetera/stories-f2.md` still carries jira_project_key CET from a pre-mapping-reset sync (CET-111 is now Done; CET-110 still active but unroutable). Left untouched — fix the mapping (cetera key F2 vs actual CET) to resume routing/archiving.
