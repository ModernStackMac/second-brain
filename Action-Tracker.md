...
> Linear stories (Meadow, Flex Dash) omitted this sync — Linear MCP requires OAuth authentication; user not present.
> MAI-1562 "Fund Assignment - Remove Assign To Account Name" dropped from tracker — no longer returned by active Jira query (likely completed/closed).
