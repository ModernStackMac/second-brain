...
> Mac Nosek's independent consulting practice focused on Salesforce, cloud architecture, DevOps, and AI tooling.

## Overview
Modern Stack Systems (MSS) is a boutique consulting firm specializing in enterprise Salesforce architecture and implementation, cloud infrastructure, CI/CD automation, AI application development, and business development. The practice operates through partner channels ([[stand8]], [[stitch]]) and direct engagements with [[high-meadows]]. Mac currently manages multiple concurrent contracts totaling 100 billable hours per week.

## Key Details

**Current Engagement Model:**
- Two 40-hour contracts through partner channels
- One 20-hour contract (likely direct/internal)
...
- AI and MCP tooling integration
- Cloud architecture design
- Business development and sales

**Mac's AI Expertise:**
- Daily Claude Code power user with $200/month subscription
- Multiple concurrent Claude instances and custom co-workflows
...
- Role details: Telephony build, AI-focused team using Claude Code, $150/hr, 40hrs/week
- Mac expressed interest in build side over pure QA, but flagged current 100-hour workload as limiting factor
