# High Meadows
> Insurance and SaaS company where Mac works on internal products and client-facing projects.

## Overview
High Meadows is an insurance/SaaS company running multiple product lines and internal tools. Mac is actively involved in product development, strategy, and engineering delivery across both internal applications and external client work. The company maintains active product teams, website management, and vendor relationships.
...
- Product strategy sessions and planning
- Development team standups and technical reviews
- Vendor distribution list: vendors@highmetasolutions.com
- SharePoint for document management (Clients + Internal folder structure), OneDrive for personal working files
- Email migration in progress: some team members (Sam, Antonio) transitioning from Glue On to High Meadows accounts
- Slack workspace migration tied to email provisioning
- Notion adoption ongoing; office hours (Fridays) as the venue for workflow questions

**Product Licensing Strategy** (2026-04-02)
- [[flex-dash]]: no AppExchange licensing — implementation fee model only. Managed package prevents partner code theft. For small clients, pad hours as implementation fees rather than recurring licenses.
- Access control (shutting off package access when client stops paying) back-burnered.

**Staffing Decisions** (2026-04-02)
- MAI flagged as highest priority — full stop on Flex-Dash development
- Argentine dev team being replaced with full-time hires (Antonio, Albin, Stephen's contact)
- Stephen (W2 dev, $16.5k retainer for 25 hrs/wk) not proactively asking for work when unassigned
